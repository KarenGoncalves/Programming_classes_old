...
install_from_dif_sources(
	...
	bioconductor_packages = c("Biostrings", "msa", "treeio", "ggtree", "ape", "seqinr"),
...
A seqlogo is a plot with letters on top of each other representing their frequency at each position in the alignment. 

- The higher and bigger a letter, the more frequent it is at a given position. 
...
## Make a phylogenetic tree with seqinr and ape
...
```{r}
myFirstAlignment3 <- 
	msaConvert(myFirstAlignment,
		   type="seqinr::alignment")

# Then, we create a distance matrix
distance_alignment <- 
	dist.alignment(myFirstAlignment3 )
