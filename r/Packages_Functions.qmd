...
```{.r}
# Load the data
timeSeries.File = "karengoncalves.github.io/ProgrammingClasses/r/exampleData/TimeSeries_example.csv"
timeSeries = read.csv(timeSeries.File, row.names = 1)
```

```{r, echo = F}
timeSeries = read.csv("exampleData/TimeSeries_example.csv")
```
...
ggplot(timeSeriesLong) +
	geom_line(aes(x = TimePoint, y = Growth_measure, 
		      group = Treatment, 
		      #' this is important
		      #' repeat this code without this line to see why
		      color = Treatment)) +
...
1. [September 19th](./exampleData/script_class2t.R)
2. [September 19th (2)](./exampleData/class_19092023.R)
2. [October 3rd](./exampleData/script_class2tuesday.R)
3. [October 10th](./exampleData/class_10102023.R)

Fridays group

1. [September 15th](./exampleData/script_class1f.R)
2. [September 29th](./exampleData/class_29092023.R)
3. [October 6th](./exampleData/class_06102023.R)
