...
Using pipe, you can see the progression of the pipeline, eg.: <br>`{.r} bachelor("Karen") %>% phd() %>% postdoc` <br>instead of <br>`{.r} postdoc(phd(bachelor("Karen")))`
