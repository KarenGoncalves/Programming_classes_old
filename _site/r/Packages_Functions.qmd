...
- `for` is a function that will repeat what you ask for everything in the group you give it. Eg: every PhD candidate has to defend their theses: 
	- `for (phd in c("Arghavan", "Vahid", "Snehi", "Serge", "Fadoua")) { thesisDefense(phd) }`
...
1. Boxplot - [check this slide](#ggplot)
	- ```geom_boxplot```
