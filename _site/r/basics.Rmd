...
```{r difference between factor and character, message=TRUE, warning=TRUE}
...
**HOW TO:** table_name**[ row_name ,]** 

> - The row name/number HAS TO come BEFORE the `","`

```{r row selection, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r column selection, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r name setting columns, echo=TRUE, message=FALSE, warning=FALSE}
# See and set the names of your columns with the function "names"
names(myPlantGrowth) 
names(myPlantGrowth) = c("Weights", "Treatments")
```
